...
if (!projectRef || !token) {
  console.error("Run: npx supabase login — then re-run node scripts/apply-pipeline-migration.mjs");
  console.error("Or paste packages/db/supabase/deploy-v0.3.0-pipeline.sql in Supabase SQL Editor");
  process.exit(1);
}
...
console.log("OK: pipeline_artifacts table ready");
